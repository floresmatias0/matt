    ...
    <>
      <form name='contact' onSubmit={handleSubmit} >
        ...
        <div className='w-full flex flex-col-reverse md:flex-row items-center justify-between'>
          ...
          <Button variant={ButtonVariation.outline} label={isSubmitted.isLoading ? legendSending : legendSend} className='w-full md:w-[initial] px-16 disabled:cursor-not-allowed' disabled={!values.subject && !values.email && !values.message} />
        </div>
      </form>
      <p className='flex items-center mt-8 justify-center md:justify-end'>
        {prefixWhatsapp}
        <a href='https://wa.me/+5491169047409' target='_blank' className='mx-1 cursor-pointer flex items-center group hover:underline'>
          Whatsapp
